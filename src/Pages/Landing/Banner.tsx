...
const Banner: FC = () => {
    ...
    const $ = (className: string) => context.scrollHandling[0] === 0 ? className : 'op-0';
            ...
            <Row className="full bg-light" align="middle">
                ...
                <Col span={8} className="front">
                    <Space direction="vertical" size="large">
                        <Content>
                            <Row align="middle">
                                <Title className={"fs-title " + $("toRight")}>Scholarship</Title>
                        ...
                        <Space size="large" className="mt-3">
                            <Button style={bg.yellow} className={"btn-home op-0 " + $("toRight wait-4")} type="primary"
                                    size="large"
                                    shape="round">
                                Get Started
                            </Button>
                            <Button onClick={() => scrollTo(1)} className={"btn-home op-0 " + $("wait-5 toRight")} type="primary"
                ...
                <Col>
                    <img className={"wait-2 half-inline " + $("toLeft")} src={image} alt=""/>
                </Col>
            </Row>
        </>
    );
