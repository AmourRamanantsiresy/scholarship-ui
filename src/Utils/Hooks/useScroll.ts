...
export const generateScrollCondition = (n: number, p: number, currentPosition: number) => {
    const positionZero = window.innerHeight * n;
    const positionDB3 = window.innerHeight / 3;
...
export const useScroll = ([currentPosition, setPosition]: TUseScroll) => {
